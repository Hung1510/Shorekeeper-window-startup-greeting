...
Play a game voice line when you log in to Windows -> a tiny silent player plus a pipeline to extract clips from Square Enix SAB audio banks 
(Final FantasyXVI voice mods in my case)

Built as a fun personal project. Works with any short `.wav`, so you can use any voice you like
