...
Make your Window Pc play a Shorekeeper voice clip when you log in, using the compiled
...
2. You should hear the clip
   ...
   - No sound? Confirm the wav is named exactly `shorekeeper_hello.wav` and is in the same folder
...
- Stop the greeting Task Scheduler -> right-click Shorekeeper Greeting ->  Delete .
